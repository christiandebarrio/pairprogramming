...
$('.ctrl-tournaments.actn-index').on('click', '[data-hook~=player-select]', selectPlayer)
$('.ctrl-tournaments.actn-index').on('change', '[data-hook~=player-list]', addPlayerToTournament)